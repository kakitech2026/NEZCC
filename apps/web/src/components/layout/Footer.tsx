        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col items-start pr-0 lg:pr-12">
            ...
            <div className="flex gap-3">
              <a href={facebookURL} target={facebookURL ? '_blank' : undefined} rel={facebookURL ? 'noopener noreferrer' : undefined} aria-disabled={!facebookURL} aria-label="Facebook" className="group w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#df5f18] hover:border-[#df5f18] transition-all duration-300">
              ...
              <a href={instagramURL} target={instagramURL ? '_blank' : undefined} rel={instagramURL ? 'noopener noreferrer' : undefined} aria-disabled={!instagramURL} aria-label="Instagram" className="group w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#df5f18] hover:border-[#df5f18] transition-all duration-300">
                <svg className="h-5 w-5 fill-current text-white/70 group-hover:text-white transition-colors" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href={xURL} target={xURL ? '_blank' : undefined} rel={xURL ? 'noopener noreferrer' : undefined} aria-disabled={!xURL} aria-label="X (Twitter)" className="group w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#df5f18] hover:border-[#df5f18] transition-all duration-300">
                <svg className="h-5 w-5 fill-current text-white/70 group-hover:text-white transition-colors" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                </svg>
              </a>
              <a href={youtubeURL} target={youtubeURL ? '_blank' : undefined} rel={youtubeURL ? 'noopener noreferrer' : undefined} aria-disabled={!youtubeURL} aria-label="YouTube" className="group w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#df5f18] hover:border-[#df5f18] transition-all duration-300">
                <svg className="h-5 w-5 fill-current text-white/70 group-hover:text-white transition-colors" viewBox="0 0 24 24" aria-hidden="true">
