  ...
  return (
    <main className="flex-grow w-full max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg">
        ...
        <nav aria-label="Breadcrumb" className="flex text-on-surface-variant font-caption text-caption mb-4">
          <ol className="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="material-symbols-outlined text-sm mx-1">chevron_right</span>
                <span className="text-on-surface font-semibold ml-1 md:ml-2">Leadership &amp; Team</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 className="font-headline-xl-mobile md:font-headline-xl text-headline-xl-mobile md:text-headline-xl text-on-surface">Leadership &amp; Team</h1>
      ...
      <section className="mb-12">
        <h2 className="font-headline-lg text-headline-lg text-on-surface mb-stack-md border-b border-outline-variant pb-2">Leadership</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-stack-md items-start">
            ...
            <div className="flex-grow">
              <h3 className="font-headline-md text-headline-md text-on-surface mb-1">Shri Alobo Naga</h3>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-stack-md items-start">
            <div className="w-32 h-32 flex-shrink-0 rounded bg-surface-container overflow-hidden">
              <img alt="Shri Z. Lhousa" className="w-full h-full object-cover" data-alt="A formal, high-resolution portrait photograph of a government official wearing professional business attire." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDiT-Z0buvApVADe9BqYfp--plPWSo6FT68pEaCwZfiaOxp5oTorgIA-ZrYUZBSQhHCvW9HSPS-TWONXrq3xT3SF4FijqVAKKVOQ2DtlzfjXOy7YCNqe-fMWRQZXet8wo9Kc0dH8T_PB6UoMbJI_UNK4eaTvGCd3vB62zXfvAYdhvjnIFiKpKx4IST1kfeoDqq6hMXEWCpdFjx646ofw6OMflR2IWGrmnWoC3z04C6ZiSPyxrY7PL3cjg"/>
            </div>
            <div className="flex-grow">
              <h3 className="font-headline-md text-headline-md text-on-surface mb-1">Shri Z. Lhousa</h3>
      ...
      <section>
        <h2 className="font-headline-lg text-headline-lg text-on-surface mb-stack-md border-b border-outline-variant pb-2">Officers &amp; Staff</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-gutter">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-headline-md text-headline-md text-on-surface text-lg">Shri Ashim Debnath</h4>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-headline-md text-headline-md text-on-surface text-lg">Shri Oliver T Pongen</h4>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-headline-md text-headline-md text-on-surface text-lg">Shri P. Yanger Lemtur</h4>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-headline-md text-headline-md text-on-surface text-lg">Shri Yashilemba</h4>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-stack-md shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-headline-md text-headline-md text-on-surface text-lg">Ms. Temsunaro</h4>
