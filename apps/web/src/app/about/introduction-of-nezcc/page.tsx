...
export default function IntroductionOfNEZCC() {
  return (
    <main className="max-w-container-max-width mx-auto px-margin-desktop py-stack-lg min-h-screen">
      {/* Breadcrumbs */}
      <nav aria-label="Breadcrumb" className="flex text-on-surface-variant font-label-md text-label-md mb-stack-lg">
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          <li className="inline-flex items-center">
            <a className="inline-flex items-center hover:text-primary transition-colors" href="/">
              Home
            </a>
          </li>
          <li>
          ...
          <li aria-current="page">
            <div className="flex items-center">
              <span className="material-symbols-outlined mx-1 text-sm">chevron_right</span>
              <span className="text-on-surface ml-1 md:ml-2 font-bold">Introduction of NEZCC</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <section className="mb-stack-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter items-center">
          <div>
            <h1 className="font-headline-xl text-headline-xl text-primary mb-stack-md">Introduction of NEZCC</h1>
          ...
          <div className="rounded-xl overflow-hidden shadow-sm border border-outline-variant bg-surface-container-lowest h-64 md:h-full relative group">
            <div className="bg-cover bg-center w-full h-full min-h-[300px]" data-alt="Photograph of the North East Zone Cultural Centre headquarters building in Dimapur, Nagaland." style={{ backgroundImage: "url('/images/about/nezcc-hq-building.jpg')" }}></div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-stack-lg bg-surface-container-low p-stack-lg rounded-xl border border-outline-variant shadow-sm">
        <h2 className="font-headline-md text-headline-md text-on-surface mb-stack-md">Constituent States</h2>
      ...
      <section className="mb-stack-lg">
        <div className="text-center max-w-2xl mx-auto mb-stack-lg">
          <h2 className="font-headline-lg text-headline-lg text-primary mb-stack-sm">Aims and Objectives</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Preserve &amp; Promote</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Develop Diversity</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Composite Identity</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Document &amp; Preserve</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Youth Involvement</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Inter-state Linkages</h3>
          ...
          <div className="bg-surface p-stack-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group md:col-span-2 lg:col-span-3 lg:w-1/3 lg:mx-auto">
            ...
            <h3 className="font-label-md text-label-md text-on-surface mb-2 font-bold">Encourage Research</h3>
      ...
      <section className="mb-stack-lg bg-surface-bright rounded-xl overflow-hidden border border-outline-variant shadow-sm">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-cover bg-center min-h-[300px] lg:min-h-full w-full" data-alt="Photograph of Shilpgram Crafts Village in Guwahati." style={{ backgroundImage: "url('/images/about/shilpgram.jpg')" }}></div>
          <div className="p-margin-desktop flex flex-col justify-center">
            ...
            <h2 className="font-headline-lg text-headline-lg text-on-surface mb-stack-sm">Shilpgram (Crafts Village)</h2>
      ...
      <section className="bg-primary text-on-primary rounded-xl p-margin-desktop text-center relative overflow-hidden shadow-sm">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h2 className="font-headline-lg text-headline-lg mb-stack-md">Unity through Culture</h2>
