...
export default function IntroductionOfNorthEast() {
  return (
    <main className="flex-grow w-full flex flex-col  md:-mt-[30px] relative z-0">
      {/* Hero Section */}
      <section className="relative w-full h-[40vh] md:h-[50vh] min-h-[300px] flex items-end pb-stack-lg" style={{ backgroundImage: "url('/images/about/ne.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="relative z-10 w-full max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="relative bg-[rgba(255,255,255,0.14)] backdrop-blur-[20px] backdrop-saturate-[1.8] p-6 md:p-10 rounded-[28px] inline-flex flex-col overflow-hidden border border-[rgba(255,255,255,0.35)] shadow-[0_8px_32px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.4),inset_0_0_0_1px_rgba(255,255,255,0.05)] transition-all duration-400 ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_16px_40px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.45),inset_0_0_0_1px_rgba(255,255,255,0.08)]">
            {/* Specular sheen (light hitting glass) */}
            <div
              className="absolute pointer-events-none top-[-60%] left-[-20%] w-[140%] h-full -rotate-[8deg]"
              style={{ background: 'linear-gradient(120deg, rgba(255,255,255,0) 30%, rgba(255,255,255,0.25) 48%, rgba(255,255,255,0) 65%)' }}
            ></div>
            <span className="font-label-sm text-label-sm text-white">Gateway to the Northeast</span>
            <h1 className="font-serif font-medium md:font-serif font-medium text-headline-xl-mobile md:text-headline-xl text-white drop-shadow-md">Introduction of North East</h1>
          </div>
        </div>
      </section>
      ...
      <div className="w-full max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg flex flex-col gap-stack-lg">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          <div className="md:col-span-2 bento-card p-6 flex flex-col justify-center bg-surface-bright border-t-4 border-t-[#FF9933]">
            <h2 className="font-serif font-medium text-headline-lg text-on-background mb-stack-md flex items-center gap-2">
        ...
        <section className="flex flex-col gap-stack-md">
          <div className="flex items-center gap-2 mb-2">
            <h2 className="font-serif font-medium text-headline-md text-primary">Member States</h2>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center py-stack-md">
          <div className="lg:col-span-5 order-2 lg:order-1 relative rounded-xl overflow-hidden h-80 shadow-md">
            <img alt="Cultural Diversity" className="absolute inset-0 w-full h-full object-cover" src="/images/unity.webp" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
              <div className="glass-card p-3 rounded text-white flex items-center gap-4">
                <div className="text-center border-r border-white/30 pr-4">
                  <span className="block font-headline-md font-bold">200+</span>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 flex flex-col gap-stack-sm pl-0 lg:pl-8">
            <span className="font-label-md text-label-md text-[#FF9933] uppercase tracking-widest font-semibold">Demographics</span>
            <h2 className="font-serif font-medium text-headline-lg text-primary leading-tight">An Ethnic &amp; Cultural Tapestry</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-gutter py-stack-sm">
          ...
          <div className="bento-card p-8 border-l-4 border-l-primary flex flex-col h-full bg-surface-bright">
            ...
            <h2 className="font-serif font-medium text-headline-md text-on-background mb-4">Economic Powerhouse</h2>
          ...
          <div className="bento-card p-8 border-l-4 border-l-[#4cb748] flex flex-col h-full relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h2 className="font-serif font-medium text-headline-md text-on-background mb-4">Nature &amp; Aesthetics</h2>
        ...
        <section className="bg-surface-container rounded-xl overflow-hidden border border-outline-variant shadow-sm flex flex-col md:flex-row my-stack-sm">
          <div className="w-full md:w-2/5 min-h-[300px] relative bg-cover bg-center" style={{ backgroundImage: "url('/images/art_heritage.webp')" }}>
          ...
          <div className="w-full md:w-3/5 p-8 md:p-10 flex flex-col justify-center">
            ...
            <h2 className="font-serif font-medium text-headline-lg text-primary mb-4">A Legacy of Art &amp; Heritage</h2>
