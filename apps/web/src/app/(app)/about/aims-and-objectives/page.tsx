...
export default function AimsAndObjectives() {
  return (
    <main className="flex-grow ">
      {/* Page Header */}
      <section className="bg-surface-container pt-16 md:pt-24 pb-12 px-margin-mobile md:px-margin-desktop">
        <div className="max-w-container-max-width mx-auto">

          
          <h1 className="font-serif font-medium text-headline-xl-mobile md:text-headline-xl text-on-surface">Aims &amp; Objectives</h1>
      ...
      <section className="py-16 px-margin-mobile md:px-margin-desktop bg-surface-lowest">
        <div className="max-w-container-max-width mx-auto">
          <h2 className="font-serif font-medium text-headline-lg text-on-surface mb-stack-lg border-b-2 border-primary inline-block pb-2">Core Objectives</h2>
      ...
      <section className="py-16 px-margin-mobile md:px-margin-desktop bg-surface-container-low">
        <div className="max-w-container-max-width mx-auto">
          <div className="bg-surface rounded-xl border border-outline-variant p-stack-lg md:p-[48px] shadow-sm">
            <h2 className="font-serif font-medium text-headline-lg text-on-surface mb-stack-lg flex items-center gap-4">
